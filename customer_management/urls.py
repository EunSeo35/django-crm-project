...
from . import views
from .views import CustomerListAPIView, CustomerCreateAPIView, CustomerStatsAPIView
...
urlpatterns = [
    ...
    path('list/', CustomerListAPIView.as_view()), #REST API 고객 목록 조회
    path('list/add/', CustomerCreateAPIView.as_view()), #REST API 고객 생성
    ...
    path('statistics/', CustomerStatsAPIView.as_view(), name='customer_statistics'),
